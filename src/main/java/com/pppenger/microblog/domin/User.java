...
public class User implements UserDetails, Serializable {
	...
	private String email; // 用户账号，用户登录时的唯一标识

	@NotEmpty(message = "账号不能为空")
	@Size(min=3, max=20,message = "账号个数必须在3和20之间")
...
//	private String name;
	...
	//评分
	@Column(nullable = false, columnDefinition = "SMALLINT default 100")
	...
	//代码中getAuthorities和四个is***方法是UserDetails接口需要实现的方法，四个is***方法都需要返回为true账户才能使用。
	@Override
